            ...
            <div class="modal-content panel panel-primary">
                ...
                <div class="modal-body panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" name="title" class="form-control input-staff-firsttitle" id="title-title" placeholder="title">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <textarea name="content" class="form-control input-staff-content" id="content" placeholder="content"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
